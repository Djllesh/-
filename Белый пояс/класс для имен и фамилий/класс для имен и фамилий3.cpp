...
private:
    ...
    vector<string> FormName(int year)
    {
        vector<string> result;
        ...
        for (int i = year; i >= limit; i--)
        {
            ...
            {
                result.push_back(firstName[i]);
            }
        }
        return result;
    }
    vector<string> FormSurname(int year)
    {
        vector<string> result;
        int limit = lastName.begin()->first;
        for (int i = year; i >= limit; i--)
        {
            if (lastName.count(i))
            {
                result.push_back(lastName[i]);
            }
        }
        return result;
    }
